...
>(({ defaultOpen = true, open...props }, ref) => {
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          style={
            {
              "--sidebar-width""--sidebar-width-icon"...style,
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          style={
            {
              "--sidebar-width"} as React.CSSProperties
          }
          side={side}
        >
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]-lg group-data-[variant=floating]-data-[variant=floating]-sidebar-border group-data-[variant=floating]"
        >
          {children}
        </div>
      </div>
...
const SidebarTrigger = React.forwardRef<React.ElementRef, React.ComponentProps>(
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after-y-0 after-1/2 after-[2px] group-data-[side=left]:-right-4 group-data-[side=right]-0 hover-sidebar-border sm",
...
const SidebarInput = React.forwardRef<React.ElementRef, React.ComponentProps>(
  ({ className, ...props }, ref) => {
    return (
      <Input
        ref={ref}
...
const SidebarSeparator = React.forwardRef<React.ElementRef, React.ComponentProps>(
  ({ className, ...props }, ref) => {
    return (
      <Separator
        ref={ref}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible-2 [&>svg]-4 [&>svg]-0",
  ...
  return (
    ...
    >
      ...
      <Skeleton
        ...
        style={
          {
            "--skeleton-width"} as React.CSSProperties
        }
      />
    </div>
  );
